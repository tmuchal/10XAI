...
//   label      title-card / hanging-sign kicker ("CHAPTER 04", "FIN"); null = no sign (the opener)
...
window.TIMELINE = /*JSON*/{
  ...
  "chapters": [
    ...
    { "id": "ch04", "dur": 28, "authoredAt": 106, "label": "CHAPTER 04", "sign": ["몰입감 만들기", "Building immersion"] },
    { "id": "ch05", "dur": 26, "authoredAt": 134, "label": "CHAPTER 05", "sign": ["전문성 × 유머", "Expertise × humor"] },
    { "id": "ch06", "dur": 24, "authoredAt": 160, "label": "CHAPTER 06", "sign": ["결국, 매출로", "Turning it into sales"] },
