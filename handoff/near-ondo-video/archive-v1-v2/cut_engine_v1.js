  ...
  const SEG = [
    {m0:1.7,  m1:5.2,  d:3.4, ch:'사건 개요'},
    {m0:22.2, m1:24.2, d:2.0, ch:'용의자 1 · 인센티브', fly:'용의자 1|인센티브'},
    {m0:28.0, m1:31.5, d:3.6, ch:'용의자 1 · 인센티브'},
    {m0:34.2, m1:36.2, d:1.8, ch:'용의자 2 · 실사용', fly:'용의자 2|실사용'},
    {m0:40.1, m1:43.7, d:2.6, ch:'용의자 2 · 실사용'},
    {m0:56.2, m1:58.0, d:1.8, ch:'용의자 3 · TVL', fly:'용의자 3|TVL 풍선'},
    {m0:62.8, m1:64.3, d:1.4, ch:'용의자 3 · TVL'},
    {m0:66.5, m1:69.3, d:2.0, ch:'용의자 4 · Ondo', fly:'용의자 4|Ondo'},
    {m0:70.0, m1:73.0, d:2.2, ch:'용의자 4 · Ondo'},
    {m0:76.1, m1:77.8, d:1.6, ch:'공범 · 시장 전체', fly:'공범|시장 전체'},
    {m0:82.9, m1:85.9, d:2.6, ch:'공범 · 시장 전체'},
    {m0:88.0, m1:90.2, d:2.2, ch:'최종 판결', fly:'최종|판결'},
    {m0:96.2, m1:100.0, d:2.8, ch:'최종 판결'}
  ];
  ...
  const CUT_CUES = [
    [0.3,  "NEAR jumped 80% in one week. Who did it?", "NEAR, 일주일 새 80% 급등. 범인은 누구?"],
    [3.5,  "Suspect one: a $70 million snapshot. Price up 14% that day.", "용의자 1: 예치금 7천만 달러 돌파, 찰칵. 그날 +14%."],
    [6.4,  "Rewards unlock only above $3.33, so every holder wants it higher.", "보상은 $3.33을 넘어야 풀린다. 그러니 다들 상승을 원한다."],
    [9.6,  "Suspect two: real usage. $31 billion moved, fees doubled.", "용의자 2: 진짜 사용량. 누적 314억 달러, 수수료는 2배."],
    [13.5, "The TVL balloon? Partly just the price going up.", "TVL 풍선? 일부는 가격이 올라서 부푼 것."],
    [16.7, "Ondo's deal came on the 23rd. The rally train had left.", "Ondo 제휴는 23일. 랠리 기차는 이미 떠났다."],
    [20.9, "Accomplices: a huge short squeeze and a privacy-coin wave.", "공범: 6억 4,800만 달러 숏스퀴즈, 그리고 프라이버시 코인 열풍."],
    [25.1, "Verdict: the incentive lit the fuse. Watch $3.33.", "판결: 불을 붙인 건 인센티브. 관건은 $3.33."],
    [28.2, "Case closed. Not investment advice.", "사건 종결. 투자 조언은 아닙니다."]
  ].map(([t, s, ko]) => ({t, s, ko}));

  // Korean variety-show pop captions: text (HTML), cut time, duration, x%, y%, tilt, size class
  const POPS = [
    {t:0.9,  d:2.3, x:50, y:30, r:-4, cls:'big', h:'일주일 <em>+80%</em>'},
    {t:2.1,  d:1.3, x:74, y:18, r:7,  cls:'sm',  h:'범인은?!'},
    {t:3.55, d:1.8, x:66, y:22, r:-5, cls:'',    h:'찰칵! <em>스냅샷</em>'},
    {t:4.6,  d:1.4, x:72, y:44, r:4,  cls:'sm',  h:'그날 <b>+14%</b>'},
    {t:6.5,  d:2.4, x:54, y:18, r:-3, cls:'',    h:'<em>$3.33</em> 넘어야 해제'},
    {t:8.0,  d:1.2, x:30, y:30, r:5,  cls:'sm',  h:'다들 오르길 원함'},
    {t:9.7,  d:1.6, x:74, y:47, r:-4, cls:'',    h:'누적 <em>314억 달러</em>'},
    {t:11.4, d:1.5, x:62, y:44, r:5,  cls:'',    h:'수수료 <b>2배!</b>'},
    {t:13.6, d:1.6, x:30, y:20, r:-5, cls:'',    h:'풍선 속 <em>착시</em>'},
    {t:15.3, d:1.3, x:66, y:22, r:4,  cls:'sm',  h:'원인이 아니라 <b>결과</b>'},
    {t:17.0, d:1.5, x:72, y:30, r:-3, cls:'sm',  h:'기차 출발~'},
    {t:18.9, d:1.7, x:44, y:34, r:-6, cls:'big', h:'<b>지각!</b>'},
    {t:21.1, d:1.7, x:50, y:57, r:-3, cls:'',    h:'숏 <b>6.48억 달러</b> 청산'},
    {t:22.9, d:1.9, x:70, y:57, r:4,  cls:'',    h:'프라이버시 <em>열풍</em>'},
    {t:25.3, d:2.0, x:62, y:20, r:-4, cls:'',    h:'1위: <em>인센티브</em>'},
    {t:27.5, d:2.5, x:50, y:22, r:3,  cls:'',    h:'관건은 <em>$3.33</em>'}
  ];

  CUT = {cues:CUT_CUES, fx:{cube:null}};
  ...
  window.__cut = {seek:cutSeek, play:cutPlay};
  ...
  const BEATS = [
    ...
    {ch:'최종 판결', how:'The podium sweeps past, then the curtains close, the CASE CLOSED stamp shakes the stage, and Hash bows to the camera.'}
  ];
